                ...
                children: [
                  Positioned(child: Container(
                    ...
                    Positioned(bottom: 10,
                      child: modified_text(text: " ⭐ Average Rating - "+vote, color: Colors.white, size: 16))
                ],
              ),
            ),
            SizedBox(height: 15,),
            Container(padding: EdgeInsets.all(10),
            child: modified_text(text: name != null?name:"Title Not Found", color: Colors.white, size: 24),),
